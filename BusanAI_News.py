...
def sentiment_badge(sentiment):
    if sentiment == "긍정":
        return '<span style="color:green; font-size:22px; position:relative; top:1px;">●</span> 긍정 논조'
    elif sentiment == "부정":
        return '<span style="color:red; font-size:22px; position:relative; top:1px;">●</span> 부정 논조'
    else:
        return '<span style="color:orange; font-size:22px; position:relative; top:1px;">●</span> 중립 논조'
